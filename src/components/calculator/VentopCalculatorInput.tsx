...
interface VentopCalculatorInputProps {
  weight: number;
  power: number;
  wkg: number;
...
const VentopCalculatorInput: React.FC<VentopCalculatorInputProps> = ({
  weight,
  power,
  wkg,
  setWeight,
    ...
    <AnimatedCard delay={200} className="flex flex-col h-full">
      <div className="mb-4">
        ...
        <p className="text-muted-foreground text-sm">
          Enter your weight and the power you can sustain for the duration of the Ven Top climb.
        </p>
      </div>
...
export default VentopCalculatorInput; 