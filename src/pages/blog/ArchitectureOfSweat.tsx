...
const ArchitectureOfSweat = () => {
  const content = (
    <div className="space-y-6">
      <div>
        <p className="mb-4">
          The room is silent. If you take away the industrial hum of the fan and the rhythmic, rhythmic thrum-thrum-thrum of the carbon drive belt, there is nothing. A cyclist sits in a garage in a suburb, staring at a wall, sweating profuse amounts of water onto a rubber mat. To an alien observer, this is a ritual of madness. The human is going nowhere. They are expending energy for no displacement. They are suffering for zero distance.
        </p>
        <p className="mb-4">
      ...
      <div>
        <h2 className="text-2xl font-bold mb-4">Gravity is Just a Line of Code</h2>
        <p className="mb-4">
      ...
      <div>
        <h2 className="text-2xl font-bold mb-4">The Strange Intimacy of the Blob</h2>
        <p className="mb-4">
          There is a specific loneliness to modern life, and a specific cure found in the "Blob." The Blob is the colloquial term for the massive, undefined groups of riders that form on flat routes or during group rides.
        </p>
        <p className="mb-4">
      ...
      <div>
        <h2 className="text-2xl font-bold mb-4">The Panopticon of the Sidebar</h2>
        <p className="mb-4">
          To the right of the screen lies the list of names, the leaderboard, the live tracker. This is the Panopticon. In philosophy, the Panopticon is a prison design where the inmates can be watched at any moment, so they must behave as if they are always being watched.
        </p>
        <p className="mb-4">
      ...
      <div>
        ...
        <p className="mb-4">
          This allows for training precision that nature forbids. The outdoor cyclist is a victim of circumstance. The wind dictates the interval. The traffic light dictates the rest period. The virtual cyclist is the god of their own domain. They control the variables. This is why the virtual rider is often stronger, pure-wattage-wise, than the outdoor purist. They have removed the chaos of the world. They have refined the act of pedaling into a laboratory experiment.
        </p>
        <p className="mb-4">
          But they have also lost something. They have lost the chaotic beauty of the crosswind. They have lost the smell of manure in the fields and the sudden temperature drop in a shadowed valley. Watopia is a sterile paradise. It is a utopia, and like all utopias, it is slightly unsettling if you look at it too long.
        </p>
      </div>
      ...
      <div>
        ...
        <p className="mb-4">
          It highlights the peculiar fragility of the male ego in the cycling world. We would rather lie to a database than admit we got dropped on a virtual volcano. The outrage we feel when we see a 45kg rider pushing 500 watts is visceral. It's not just that they are cheating; it's that they are breaking the immersion. They are reminding us that this is just a game. They are pulling back the curtain and showing us the wizard. We hate the weight doper because they ruin our collective dream that what we are doing matters.
        </p>
      </div>

      <div>
        <h2 className="text-2xl font-bold mb-4">Sunset on the Makuri Islands</h2>
        <p className="mb-4">
          There is a moment, specifically in the Makuri Islands maps, when the virtual sun sets. The lighting engine in the game shifts. The shadows get long. The neon lights of Neokyo flicker on.
        </p>
        <p className="mb-4">
          It is beautiful. And it is completely procedurally generated.
        </p>
        <p className="mb-4">
          There is a profound philosophical question hidden in the pixelated sunset: Can an artificial experience generate real emotion? If your heart rate is 170, your endorphins are flooding your brain, and you feel a sense of awe at the digital landscape, is that feeling "fake"?
        </p>
        <p className="mb-4">
          The brain doesn't seem to think so. The dopamine is real. The exhaustion is real. The satisfaction of cresting the climb is real.
        </p>
        <p className="mb-4">
          We have built a world where we can be heroes in our own basements. We can act out the drama of the breakaway, the tragedy of the bonk, and the redemption of the sprint finish, all before dinner. Watopia is not a replacement for the real world; it is a supplement to it. It is a place where we go to sharpen the blade, to converse with our demons in a safe environment, and to remind ourselves that even when we are going nowhere, we are still moving forward.
        </p>
        <p className="mb-4">
          The fan hums. The chain spins. The avatar stands up to sprint. And for a brief second, the ghost in the machine is the most alive thing in the room.
        </p>
      </div>
    </div>
  );
...
export default ArchitectureOfSweat;
