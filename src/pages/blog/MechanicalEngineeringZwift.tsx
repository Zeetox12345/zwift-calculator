...
const MechanicalEngineeringZwift = () => {
  ...
  return (
    <BlogPost
      ...
      content={content}
      metaTitle="The Mechanical Engineering of Zwift Performance: Why Physics Matters | Zwift Calculator"
      metaDescription="Explore Zwift performance through mechanical engineering principles. Learn about power production, polynomial regression, equipment weight physics, and the thermodynamics of virtual cycling performance."
    />
  );
};
