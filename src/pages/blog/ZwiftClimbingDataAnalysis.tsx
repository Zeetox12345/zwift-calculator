...
const ZwiftClimbingDataAnalysis = () => {
  ...
  return (
    <BlogPost
      ...
      content={content}
      metaTitle="The Data Behind Zwift Climbing: What 1,000+ Rides Tell Us About Performance | Zwift Calculator"
      metaDescription="Discover data-driven insights from analyzing 1,000+ ZwiftPower performances. Learn about pacing patterns, power distribution, common mistakes, and training implications for Zwift climbing performance."
    />
  );
};
